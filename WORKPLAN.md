...
| **C** Home + Matches UI | `agent/c-home-matches` | 2 | `src/app/(site)/page.tsx`, `src/app/(site)/matches/`, `src/app/(site)/schedule/`, `src/app/(site)/results/`, `src/components/matches/`, `src/components/charts/`, `src/components/sports/` | A (API/services), B (ui kit) | 🟢 xong |
